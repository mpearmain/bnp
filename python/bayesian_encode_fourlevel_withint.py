...
def prepData(var4_col="v52"):
	...
	train.to_csv("train_4levelenc_withint.csv", index=False)
	test.to_csv("test_4levelenc_withint.csv", index=False)
...
def prepModelXGB(var4_col="v52"):
	...
	print "Cross validating.."
        ...
        out_df = pd.DataFrame({"ID":train_ID})
        out_df["xg1_srk_4levelenc_withint"] = train_preds
        out_df.to_csv("prval_xg1_srk_4levelenc_withint.csv", index=False)
	...
	out_df = pd.DataFrame({"ID":test_ID})
        out_df["xg1_srk_4levelenc_withint"] = preds
        out_df.to_csv("prfull_xg1_srk_4levelenc_withint.csv", index=False)
