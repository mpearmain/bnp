...
if __name__ == "__main__":
	...
	train = pd.read_csv("./train_dvencode.csv")
	test = pd.read_csv("./test_dvencode.csv")
	...
	train.to_csv("train_dvencode_3level.csv", index=False)
	test.to_csv("test_dvencode_3level.csv", index=False)
