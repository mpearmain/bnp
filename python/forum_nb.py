# -*- coding: utf-8 -*-
"""
Created on Wed Mar 16 15:36:00 2016

@author: https://www.kaggle.com/scirpus/bnp-paribas-cardif-claims-management/benouilli-naive-bayes/code
"""
...
if __name__ == "__main__":
    ...
    print('Start Output')
    secondtrain.to_csv('../submissions/2ndnbxgbtrain.csv', index=False)
    secondtest.to_csv('../submissions/2ndnbxgbtest.csv', index=False)
